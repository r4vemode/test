...
const Volochkova = () => {
  const [score, setScore] = useState(2341)
      ...
      <div className={'oneArticle'}>
        <div className="container">
          ...
          <div className="oneArticle__img-container">
            <img className={'oneArticle__img'} src="/images/volok.jpg" alt=""/>
          </div>
          <div className="oneArticle__container">
            ...
            <div className="oneArticle__text-container">
              <h1 className="oneArticle__title">
                "Еле на ногах держится, чуть со сцены не покатилась": Волочкова крупно опозорилась
              </h1>
              <p className="oneArticle__text">
                Анастасия Волочкова опубликовала в соцсети фрагмент недавнего выступления. В ролике балерина исполнила
                одну из своих песен. <br/>
                <br/>
                Не хотите пропустить важные новости? Тогда подписывайтесь на Telegram-канал «А теперь внимание!».<br/>
                <br/>
                Для выхода на сцену артистка выбрала короткое белоснежное платье и бежевые босоножки на высоких каблуках
                с платформой.<br/>
                <br/>
                Многие пользователи раскритиковали кадры.<br/>
                <br/>
                «Она точно балерина? Мне кажется, я сейчас посмотрел танец кочерги под фанеру»; «Ужас. Ни слуха, ни
                чувства такта. Робот на шарнирах. Про пение вообще молчу»; «Позорище. Еле на ногах держится, чуть со
                сцены не покатилась на этих каблучищах-копытах», — написали они.<br/>
              </p>
            </div>
          </div>
        </div>

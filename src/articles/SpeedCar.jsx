...
const SpeedCar = () => {
  const [score, setScore] = useState(8866)
      ...
      <div className={'oneArticle'}>
        <div className="container">
          ...
          <div className="oneArticle__img-container">
            <img className={'oneArticle__img'} src="/images/speedst-car.jpg" alt=""/>
          </div>
          <div className="oneArticle__container">
            ...
            <div className="oneArticle__text-container">
              ...
              <p className="oneArticle__text">
                  Tuatara <br/>
                <br/>
                  Два месяца назад фирма SSC North America объявила свой гиперкар Tuatara самым быстрым серийным автомобилем в мире.<br/>
                <br/>
                  Как было заявлено, во время заездов на 11-километровом участке шоссе SR 160 в американском штате Невада он набрал 484,53 км/ч при движении в одну сторону и невероятные 532,93 км/ч — в другую.<br/>
                <br/>
              </p>
            </div>
          </div>

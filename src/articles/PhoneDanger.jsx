      ...
      <div className={'oneArticle'}>
        <div className="container">
          ...
          <div className="oneArticle__img-container">
            <img className={'oneArticle__img'} src="/images/phone-danger.jpg" alt=""/>
          </div>
          <div className="oneArticle__container">
            ...
            <div className="oneArticle__text-container">
              <h1 className="oneArticle__title">
                  Чем опасен телефон? В чем обвиняют мобильную связь?
              </h1>
              <p className="oneArticle__text">
                  Считается, что смартфон, как и любой современный телефон, — источник электромагнитного излучения. Длительное воздействие его провоцирует развитие злокачественных опухолей. <br/>
                <br/>
                  Сторонники этой теории полагают, что приближая гаджет к телу мы способствуем нарушению активности мозга, понижению когнитивных функций, развитию сердечно-сосудистых заболеваний.<br/>
                <br/>
                  По мнению некоторых экспертов, облучение, исходящее от мобильных устройств, приводит к генным мутациям.<br/>
                <br/>
                  Все эти мифы возникли тогда, когда не существовало достаточного количества статистических данных, ведь смартфоны вошли в нашу жизнь не очень давно.<br/>
                <br/>
                  Ученые пришли к выводу, что радиоизлучение наших гаджетов низкое, оно незначительно отличается от теле- и радиосигналов. Получить нарушение ДНК таким способом невозможно.
              </p>
            </div>
          </div>
        </div>

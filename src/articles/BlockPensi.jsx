...
const BlockPensi = () => {
  const [score, setScore] = useState(5435)
      ...
      <div className={'oneArticle'}>
        <div className="container">
          ...
          <div className="oneArticle__img-container">
            <img className={'oneArticle__img'} src="/images/pensionery.webp" alt=""/>
          </div>
          <div className="oneArticle__container">
            ...
            <div className="oneArticle__text-container">
              <h1 className="oneArticle__title">
                  Решение принято, теперь так делать нельзя: новый запрет для пенсионеров вступает в силу
              </h1>
              <p className="oneArticle__text">
                  У пенсионеров различными способами выманивают различную информацию, благодаря которой можно украсть деньги с банковского счета. Обычно мошенники звонят пожилым россиянам и представляются сотрудниками банка. <br/>
                <br/>
                  Как защитить себя от таких мошенников? Пенсионерам не стоит сообщать свои личные данные никому. Банки, порталы госуслуг и другие организации никогда не просят своих клиентов сообщать логин и пароль по телефону или в соцсетях. Если у вас возникли подозрения на мошеннические действия, то лучше обратиться в полицию.<br/>
                <br/>
                  Кроме того, следует установить антивирусное программное обеспечение на свой компьютер и не переходить по подозрительным ссылкам в электронных письмах или на сайтах. Важно помнить, что мошенники используют разные методы и всегда придумывают что-то новое, поэтому не стоит доверять незнакомым людям и быть бдительными в интернете.<br/>
                <br/>
              </p>
            </div>
          </div>

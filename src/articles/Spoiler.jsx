      ...
      <div className={'oneArticle'}>
        <div className="container">
          ...
          <div className="oneArticle__img-container">
            <img className={'oneArticle__img'} src="/images/spoiler.jpg" alt=""/>
          </div>
          <div className="oneArticle__container">
            ...
            <div className="oneArticle__text-container">
              <h1 className="oneArticle__title">
                Какой вид техники в детективах может быть спойлером?
              </h1>
              <p className="oneArticle__text">
                  Apple не даёт разрешения на использование своих гаджетов отрицательными киноперсонажами. <br/>
                <br/>
                  Поэтому когда мы видим на экране в чьих-то руках iPhone, это значит, что данный персонаж положительный либо нейтральный. <br/>
                <br/>
                  В детективах или триллерах такая информация может стать спойлером.<br/>

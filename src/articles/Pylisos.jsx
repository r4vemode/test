...
const Pylisos = () => {
  const [score, setScore] = useState(3333)
      ...
      <div className={'oneArticle'}>
        <div className="container">
          ...
          <div className="oneArticle__img-container">
            <img className={'oneArticle__img'} src="/images/pilik.webp" alt=""/>
          </div>
          <div className="oneArticle__container">
            ...
            <div className="oneArticle__text-container">
              <h1 className="oneArticle__title">
                  Сделайте это со своим старым пылесосом - станет в разы мощнее
              </h1>
              <p className="oneArticle__text">
                  Часто пылесос теряет свою мощность из-за банальных причин. Хозяйкам рассказали, что же нужно сделать, чтобы прибор собирал пыль лучше. Передает «А теперь внимание!». <br/>
                <br/>
                  Сначала опустошите пылесборник, а потом посмотрите, нет ли в шланге засоров. Обязательно удостоверьтесь в том, что грязь не скопилась в местах соединений.<br/>
                <br/>
                  Осмотрите щетку-валик, на которую часто наматываются волосы и другой мусор.<br/>
                <br/>
                  Зачастую простая чистка возвращает мощность пылесосу<br/>
                <br/>
              </p>
            </div>
          </div>

...
const Nusha = () => {
  const [score, setScore] = useState(5234)
      ...
      <div className={'oneArticle'}>
        <div className="container">
          ...
          <div className="oneArticle__img-container">
            <img className={'oneArticle__img'} src="/images/nusha.jpg" alt=""/>
          </div>
          <div className="oneArticle__container">
            ...
            <div className="oneArticle__text-container">
              <h1 className="oneArticle__title">
                  «Остаются синяки»: Нюша рассказала, как восстанавливает фигуру после родов
              </h1>
              <p className="oneArticle__text">
                  <br/>
                  Ранее поклонники и СМИ заметили на животе исполнительницы темные пятна, похожие на синяки. Как призналась артистка, это последствия акупунктуры (иглоукалывания. – Прим. ред.) – процедуры, к которой она прибегла, чтобы избавиться от растяжек.
                <br/>
                  "У меня оставались растяжки на животе, – рассказала Нюша. – И вот эти синяки на животе от уколов. Я прокалывала препарат, который в течение года как бы взращивает новый слой коллагена в теле".<br/>
                <br/>
                  Нюша добавила, что после иглоукалываний ей также делают массаж, чтобы размять препарат. Синяки, которые появляются после процедуры исчезают, как правило, через неделю.<br/>
                <br/>
                  "Они проходят. Но топики с открытым животом я пока носить не могу", – подытожила с улыбкой Нюша.<br/>
                <br/>
                  Певица вместе с мужем Игорев Сивовым воспитывает двоих детей: дочь Симбу (пять лет) и сына Саффрона, который родился в июле прошлого года в клинике в Дубае.
              </p>
            </div>
          </div>
        </div>

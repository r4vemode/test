...
const ChillSea = () => {
  const [score, setScore] = useState(6435)
      ...
      <div className={'oneArticle'}>
        <div className="container">
          ...
          <div className="oneArticle__img-container">
            <img className={'oneArticle__img'} src="/images/more.jpg" alt=""/>
          </div>
          <div className="oneArticle__container">
            ...
            <div className="oneArticle__text-container">
              <h1 className="oneArticle__title">
                  Всех, кто собирается на отдых на Черное море, строго предупредили: важное заявление ученых
              </h1>
              <p className="oneArticle__text">
                  Заведующий лабораторией моделирования поверхностных вод Института водных проблем РАН Михаил Болгов предупредил россиян, которые собираются отдохнуть этим летом на Черном море. <br/>
                <br/>
                  Дело в том, что из-за разрушения Каховской ГЭС существует риск загрязнения Черного моря. Несмотря на то, что большую часть опасных веществ «перехватит» Днепро-Бугский лиман, угроза загрязнения черноморских курортов все равно остается, хотя и является крайне низкой, пишет РБК.<br/>
                <br/>
                  Смыло большое количество скотомогильников ,кладбищ, скота, домашней птицы, удобрений, канализационных отходов, очистных сооружений, химических веществ и тп.<br/>
                <br/>
                  По словам профессора Российского государственного гидрометеорологического университета Валерия Малинина, с точки зрения экологии разрушение Каховской ГЭС является самой серьезной катастрофой в Европе в XXI веке.<br/>
                <br/>
              </p>
            </div>
          </div>

...
const Pensionery = () => {
  const [score, setScore] = useState(6877)
      ...
      <div className={'oneArticle'}>
        <div className="container">
          ...
          <div className="oneArticle__img-container">
            <img className={'oneArticle__img'} src="/images/pensia.jpg" alt=""/>
          </div>
          <div className="oneArticle__container">
            ...
            <div className="oneArticle__text-container">
              <h1 className="oneArticle__title">
                  Нынешние пенсионеры, у которых есть стаж работы в СССР в объёме не менее 20 лет, имеют право на получение надбавки к пенсии.
              </h1>
              <p className="oneArticle__text">
                  Нынешние пенсионеры, у которых есть стаж работы в СССР в объёме не менее 20 лет, имеют право на получение надбавки к пенсии.<br/>
                  Об этом рассказали представители Пенсионного фонда страны.<br/>
                  Работавшие ещё во времена существования Советского Союза граждане России могут рассчитывать на получение солидной прибавку к своим привычным денежным выплатам. Её максимальный размер составляет порядка 6500 рублей.<br/>
                <br/>
                  Претендовать на неё могут не все. Самое главное требование — это иметь необходимый стаж. Тогда осуществляется простой расчёт: 1% добавляется за каждый отработанный год до 1992, а за каждый год в период с 1992 по 2002 годы — ещё 10%.<br/>
                <br/>
                  Важно, что для назначения пенсионеру правильного коэффициента при расчёте выплаты, нужно учитывать ещё и стаж и в самом начале нулевых годов, а именно — до 2002 года. Тогда такой пенсионер сможет рассчитывать на коэффициент 0,55.<br/>
                <br/>
              </p>
            </div>
          </div>

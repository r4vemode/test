...
const Pugacheva = () => {
  const [score, setScore] = useState(4342)
      ...
      <div className={'oneArticle'}>
        <div className="container">
          ...
          <div className="oneArticle__img-container">
            <img className={'oneArticle__img'} src="/images/pugacheva.jpg" alt=""/>
          </div>
          <div className="oneArticle__container">
            ...
            <div className="oneArticle__text-container">
              <h1 className="oneArticle__title">
                  Названа преемница укатившей за границу Пугачевой: Волевым характером обладает
              </h1>
              <p className="oneArticle__text">
                  Алла Пугачева многие годы занимала место главной звезды отечественного шоу-бизнеса.<br/>
                <br/>

                  После ее отъезда с мужем-иноагентом и детьми многие стали интересоваться, кто мог бы занять опустевшее место дивы всея шоубиза. <br/> Критик Евгений Бабичев считает, что подобная женщина в России есть, и ее харизмы хватит, чтобы встать на первое место в негласном рейтинге. По сути, названа преемница уехавшей за границу Аллы Пугачевой.<br/>
                <br/>
                  В его словах действительно есть смысл. В последние месяцы артистка стала законодательницей трендов и вирусного контента.<br/> Лолитой восхищаются и люди ее поколения, и молодежь, которая без ума от юмора и самоиронии звезды. Артистка без стеснения рассуждает о жизни, мудро сглаживая острые углы, не боится рисковать в творчестве и выходах на красную дорожку.
                <br/>
                  Напомним, Алла Пугачева разозлила поклонников своей позицией относительно россиян.
                <br/>
                  В Сети отмечают, что позиция может быть какой угодно, но оскорблять страну, в которой прожил большую часть жизни, людей, благодаря которым стал известным, – подло.<br/> Примадонне до сих пор не могут простить слова о "рабах" и "холопах" в адрес россиян.
              </p>
            </div>
          </div>
        </div>

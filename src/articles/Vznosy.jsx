...
const Vznosy = () => {
  const [score, setScore] = useState(3588)
      ...
      <div className={'oneArticle'}>
        <div className="container">
          ...
          <div className="oneArticle__img-container">
            <img className={'oneArticle__img'} src="/images/vznos.webp" alt=""/>
          </div>
          <div className="oneArticle__container">
            ...
            <div className="oneArticle__text-container">
              <h1 className="oneArticle__title">
                  В России отменяют взносы за капремонт: стало известно, кто будет освобожден
              </h1>
              <p className="oneArticle__text">
                  Юрист Елена Кудерко объяснила, кто из российских граждан имеет законное право не оплачивать капитальный ремонт.<br/>
                <br/>
                  Первым делом, это относится к жителям аварийных домов, которые будут снесены. Никто не будет делать капитальный ремонт этих зданий, поэтому сбор денег на такие цели бессмысленен.
                  <br/>
                <br/>
                  Люди, которые достигли 80-летнего возраста и проживают одни или с родственником-инвалидом или пенсионером, тоже освобождаются от оплаты взносов.<br/>
                <br/>
                  Кроме того, государство компенсирует 30% от взносов ветеранам ВОВ, ветеранам труда и многодетным семьям. Россияне в возрасте от 70 до 79 лет могут получить «скидку» в 50% по взносам, сообщает «Прайм».
                  <br/>
                <br/>
              </p>
            </div>

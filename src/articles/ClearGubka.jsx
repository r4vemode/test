...
const ClearGubka = () => {
  const [score, setScore] = useState(9431)
      ...
      <div className={'oneArticle'}>
        <div className="container">
          ...
          <div className="oneArticle__img-container">
            <img className={'oneArticle__img'} src="/images/clear-gubka.jpg" alt=""/>
          </div>
          <div className="oneArticle__container">
            ...
            <div className="oneArticle__text-container">
              <h1 className="oneArticle__title">
                  Как очистить губку для мытья посуды? Есть как минимум 4 способа
              </h1>
              <p className="oneArticle__text">
                  Про опасность бактерий на губках и лучшие средства для дезинфекции.<br/>
                  Со временем губка для мытья посуды может потерять форму и стать настоящим рассадником бактерий, что вынуждает нас отправить её в мусорное ведро. Однако некоторые стараются максимально оттянуть этот момент, часто промывая губку и дезинфицируя.<br/> Можно ли так делать и насколько это эффективно? На этот вопрос постаралась ответить группа немецких учёных.<br/>
                  Исследователи проанализировали бактерии на 14 кухонных губках, часть из которых чистилась на регулярной основе. Результаты тестов следующие:

                  на губках действительно скапливается множество самых различных бактерий, но все они абсолютно безвредны для здоровых людей<br/>
                  дезинфекция губки никак не повлияет на уровень или скорость её дальнейшего загрязнения — бактерии всё равно вернутся, хотя может и в другом «составе»<br/>
                  и тем не менее, в дезинфекции кухонных губок действительно есть смысл.<br/>
                  Старший автор исследования Маркус Эгерт предложил свой способ очистки кухонных губок — он предпочитает бросать их в стиральную машину с порошковым моющим средством и отбеливателем.<br/> Есть и другие способы с доказанной эффективностью. Вот три решения от Университета штата Мичиган:<br/>
                  Поместите влажную губку в микроволновую печь на одну минуту при высокой температуре.<br/>
                  Бросьте губку в посудомоечную машину на самую длительную мойку при самой высокой температуре нагрева (плюс цикл сушки).<br/>
                  Замочите губку в разбавленном отбеливателе на одну минуту.<br/>
              </p>
            </div>
          </div>
        </div>

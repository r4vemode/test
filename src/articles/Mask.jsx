...
const Mask = () => {
  const [score, setScore] = useState(5322)
      ...
      <div className={'oneArticle'}>
        <div className="container">
          ...
          <div className="oneArticle__img-container">
            <img className={'oneArticle__img'} src="/images/maskaas.jpg" alt=""/>
          </div>
          <div className="oneArticle__container">
            ...
            <div className="oneArticle__text-container">
              <h1 className="oneArticle__title">
                Косметологи подсказали, как омолодить кожу лица в домашних условиях
              </h1>
              <p className="oneArticle__text">
                Действенная маска для проблемной кожи лица. Специалисты рассказали о том, как сделать омолаживающую
                маску с противовоспалительным действием. Показания к применению такой маски – проблемная кожа. <br/>
                <br/>
                Это кожа, склонная к излишней сухости или сальности, появлению прыщей, сосудистых дефектов, пигментации
                и других косметических недостатков. Для приготовления маски для проблемной кожи понадобится один яичный
                белок, три капли эфирного масла чайного дерева и порошок картофельного крахмала.<br/>
                <br/>
                Следует взбить белок в крепкую пену и добавить масло. Смесь довести крахмалом до консистенции густой
                сметаны. Готовый крахмально-белковый состав равномерно нанести на кожу лица и выдержать 15 минут.
                Смывать маску водой комнатной температуры, кожу смазать тоником и нанести крем для проблемной кожи.<br/>
              </p>
            </div>
          </div>
        </div>

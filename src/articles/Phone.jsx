...
const Phone = () => {
  const [score, setScore] = useState(4333)
      ...
      <div className={'oneArticle'}>
        <div className="container">
          ...
          <div className="oneArticle__img-container">
            <img className={'oneArticle__img'} src="/images/phone.jpg" alt=""/>
          </div>
          <div className="oneArticle__container">
            ...
            <div className="oneArticle__text-container">
              <h1 className="oneArticle__title">
                  Кто изобрел телефон? В каком году он был придуман?
              </h1>
              <p className="oneArticle__text">
                  кто первым изобрел телефон В 1861 году учёный из Германии Филипп Райс придумал устройство, которое могло передавать по кабелю всевозможные звуки.<br/>
                <br/>
                  Это и был первый телефон. (Стоит ознакомиться с тем, кто изобрёл телевизор и его историей создания)<br/>
                <br/>
                  Райсу не удалось зарегистрировать патент на своё изобретение, поэтому не стал так широко известен, как американец Александр Белл.<br/>
                <br/>
